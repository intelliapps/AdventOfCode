...
class AdventOfCodeTest
{
    ...
    @Test
    void testDayNineTest() throws Exception
    {
        assertEquals("[109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99]", Arrays.toString(new DayNine("109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99", ",").test()));
        assertEquals("[1219070632396864]", Arrays.toString(new DayNine("1102,34915192,34915192,7,4,7,99,0", ",").test()));
    ...
    @Test
    void testDayFourteenPartOne()
    {
        assertEquals(165, new DayFourteen("9 ORE => 2 A\n8 ORE => 3 B\n7 ORE => 5 C\n3 A, 4 B => 1 AB\n5 B, 7 C => 1 BC\n4 C, 1 A => 1 CA\n2 AB, 3 BC, 4 CA => 1 FUEL", "\n").partOne());
        assertEquals(13312, new DayFourteen(
                "157 ORE => 5 NZVS\n" +
                "165 ORE => 6 DCFZ\n" +
        ...
        assertEquals(180697, new DayFourteen(
                ...
                "176 ORE => 6 VJHF", "\n").partOne());
        assertEquals(2210736, new DayFourteen(
                "171 ORE => 8 CNZTR\n" +
    ...
    @Test
    void testDayFourteenPartTwo()
    {
        assertEquals(82892753, new DayFourteen(
                "157 ORE => 5 NZVS\n" +
                        "165 ORE => 6 DCFZ\n" +
                        "44 XJWVT, 5 KHKGT, 1 QDVJ, 29 NZVS, 9 GPVTF, 48 HKGWZ => 1 FUEL\n" +
                        "12 HKGWZ, 1 GPVTF, 8 PSHF => 9 QDVJ\n" +
                        ...
                        "165 ORE => 2 GPVTF\n" +
                        "3 DCFZ, 7 NZVS, 5 HKGWZ, 10 PSHF => 8 KHKGT", "\n").partTwo());
        assertEquals(5586022, new DayFourteen(
                "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG\n" +
                        "17 NVRVD, 3 JNWZP => 8 VPVL\n" +
                        "53 STKFG, 6 MNCFX, 46 VJHF, 81 HVMC, 68 CXFTF, 25 GNMV => 1 FUEL\n" +
                        "22 VJHF, 37 MNCFX => 5 FWMGM\n" +
                        ...
                        "1 VJHF, 6 MNCFX => 4 RFSQX\n" +
                        "176 ORE => 6 VJHF", "\n").partTwo());
        assertEquals(460664, new DayFourteen(
                "171 ORE => 8 CNZTR\n" +
                        "7 ZLQW, 3 BMBT, 9 XCVML, 26 XMNCP, 1 WPTQ, 2 MZWV, 1 RJRHP => 4 PLWSL\n" +
                        "114 ORE => 4 BHXH\n" +
                        "14 VRPVC => 6 BMBT\n" +
